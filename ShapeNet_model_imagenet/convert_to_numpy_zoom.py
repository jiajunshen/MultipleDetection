...
for item in items:
    texture_dataset_path = "/hdd/Documents/Data/shapeNetTexture_small_real_10class/shapeNetTexture_small_realbackground_%s/" %(item)
    ...
    np.save("/hdd/Documents/Data/ShapeNetCoreV1/real_background_%s.npy" %(item), texture_all_data)
