...
def build_cnn(input_var=None, batch_size = None):
    ...
    weight_decay_layers = {network_transformed_TPS:0.5, fc2:0.2}
...
def main(model='mlp', num_epochs=1):
    ...
    for epoch in range(num_epochs):
        ...
        #    weightsOfParams = lasagne.layers.get_all_param_values(network)
        #    np.save("../data/mnist_CNN_params_drop_out_Chi_2017_Deformation_hinge_2000_script_run_reg_0_5_MNIST_em_new_epoch%d.npy" %epoch, weightsOfParams)
