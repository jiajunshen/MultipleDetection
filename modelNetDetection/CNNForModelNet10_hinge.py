...
def main(model='mlp', num_epochs=3000):
    # Load the dataset
    print("Loading ModelNet10 data...")

    X_train, y_train, X_test, y_test = load_data("/X_train.npy", "/Y_train.npy", "/X_test.npy", "/Y_test.npy", "MODELNET10")
    ...
    weightsOfParams = np.load("../data/NIN_ModelNet10_softmax_epoch200.npy")
    ...
    for epoch in range(num_epochs):
        ...
        if epoch % 100 == 0 and epoch != 0:
            ...
            np.save("../data/NIN_ModelNet10_hinge_epoch%d.npy" % epoch, weightsOfParams)
