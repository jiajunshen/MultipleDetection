...
def main(model='mlp', num_epochs=500, training_num=60000, testing_file = "/cifar10_test_decluttered_white_tmp_new.npy"):
    # Load the dataset
    print("Loading data...")
...
if __name__ == '__main__':
    ...
    main(training_num = training_num, testing_file = testing_file)
