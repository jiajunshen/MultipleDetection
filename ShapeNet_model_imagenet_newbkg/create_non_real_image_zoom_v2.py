...
for item in items:
    ...
    for f in IKEA_texture_img_path:
        ...
        image_directory = "/hdd/Documents/Data/shapeNetTexture_small_10class/shapeNetTexture_small_whitebackground_%s/" %(item)
        mask_directory = "/hdd/Documents/Data/shapeNetTexture_small_mask_10class/shapeNetTexture_mask_small_%s/" %(item)
        try:
        ...
        try:
            os.stat(mask_directory)
        except:
            os.mkdir(mask_directory)

        misc.imsave("/hdd/Documents/Data/shapeNetTexture_small_10class/shapeNetTexture_small_whitebackground_%s/" %(item) + f.split("/")[6], new_image_final_f)
        misc.imsave("/hdd/Documents/Data/shapeNetTexture_small_mask_10class/shapeNetTexture_mask_small_%s/" %(item) + f.split("/")[6], mask_all_f.reshape(32, 32))
