...
def build_cnn(input_var=None, batch_size = None):
    ...
    output_transformed = lasagne.layers.ReshapeLayer(input_transformed, (-1, 10, 10, ORIGINAL_IMAGE_SIZE, ORIGINAL_IMAGE_SIZE))

    output_selected = SelectLayer(output_layer, 10)

    # Weight Decay
    weight_decay_layers = {original_transformed: 0.0, output_layer: 0.0}
