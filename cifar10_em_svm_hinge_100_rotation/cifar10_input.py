...
def extend_images(images, dim = 46):
    ...
    extended_images_res = np.pad(extended_images_res, ((0,), (0,), (extended_size,),(extended_size,)), mode="reflect")
...
def read_data_sets(data_dir, distortion=True, dtype=np.float32):
    ...
    train = DataSet(extend_images(train_images[:200]), train_labels[:200], distortion=distortion)
