...
def build_cnn(input_var=None, batch_size = None):
    ...
    # conv1
    conv1 = Conv2DLayer(input_transformed, num_filters=64, filter_size=(3,3),
    ...
    output_transformed = lasagne.layers.ReshapeLayer(input_transformed, (-1, 10, 10, IMAGE_SIZE, IMAGE_SIZE))

    output_selected = SelectLayer(output_layer, 10)

    # Weight Decay
    weight_decay_layers = {input_transformed:0.0, fc2: 0.0}
