...
_, _, X_test_rotated, y_test_rotated = load_data("/X_train.npy", "/Y_train.npy", "/X_test_rotated_%d.npy" %degree_rot, "/Y_test_rotated_%d.npy" %degree_rot)
