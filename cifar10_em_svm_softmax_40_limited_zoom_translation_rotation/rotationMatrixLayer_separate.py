...
class RotationTransformationLayer(lasagne.layers.Layer):
    ...
    def __init__(self, incoming, n, name=None, Degree = lasagne.init.Normal(5), Scaling = lasagne.init.Normal(1), Translation = lasagne.init.Normal(5), **kwargs):
        ...
        self.Degree = self.add_param(Degree, (n, 1), name = "Degree")
