...
def main(model='mlp', num_epochs=500):
    ...
    """
    X_train, y_train, X_test, y_test = load_data("/X_small_train_texture.npy",
                                                 "/Y_small_train.npy",
                                                 "/X_test_texture.npy",
                                                 "/Y_test.npy",
                                                 resize=False,
    ...
    X_train, y_train, X_test, y_test = load_data("/X_train_plain.npy",
                                                 "/Y_train.npy",
                                                 "/X_test_plain.npy",
                                                 "/Y_test.npy",
                                                 resize=False,
    ...
    #np.save("../data/plain_rotation_network_ShapeNet.npy", weightsOfParams)
