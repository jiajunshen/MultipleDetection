...
plain_dataset_path = "/hdd/Documents/Data/ShapeNetCoreV2/real_plain_image_mask/"
texture_dataset_path = "/hdd/Documents/Data/ShapeNetCoreV2/real_texture_image_mask/"
...
all_label = [f.split("_")[3] for f in plain_path_list]
print(all_label)
