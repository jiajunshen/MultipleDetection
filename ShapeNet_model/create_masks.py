...
for f, g in zip(IKEA_plain_img_path, IKEA_texture_img_path):
    ...
    misc.imsave("/hdd/Documents/Data/ShapeNetCoreV2/real_plain_image_mask/" + f.split("/")[6], new_image_final_f)
    misc.imsave("/hdd/Documents/Data/ShapeNetCoreV2/real_texture_image_mask/" + f.split("/")[6], new_image_final_g)
