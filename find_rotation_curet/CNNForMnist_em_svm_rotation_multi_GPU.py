...
def main(model='mlp', num_epochs=2000):
    ...
    saved_weights = np.load("../data/curet_test_hinge_epoch_1200_2pool.npy")
    ...
    for epoch in range(num_epochs):
        ...
        if epoch % 20 == 0:
            weightsOfParams = lasagne.layers.get_all_param_values(network)
            np.save("../data/Curet_CNN_Hinge_epoch_%d_2pool_8rotation_sbatch.npy" %epoch, weightsOfParams)
