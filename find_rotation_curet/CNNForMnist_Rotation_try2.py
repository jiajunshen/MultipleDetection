...
def build_cnn(input_var=None, batch_size = None):
    ...
    weight_decay_layers = {fc1:0.00, fc2:0.00, fc3:0.00}
...
def main(model='mlp', num_epochs=500):
    ...
    saved_weights = np.load("../data/curet_test_hinge_epoch_300_2pool_61_classes.npy")
    ...
    np.save("../data/curet_justRotation_try2.npy", weightsOfParams)
