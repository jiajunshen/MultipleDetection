    ...
    for epoch in range(num_epochs):
        ...
        for batch in iterate_minibatches(X_train, y_train, 100, shuffle=True):
            ...
            if train_batches == 1 and epoch % 5 == 0:
                np.save("./unrotated_image_train_cnn_rot.npy", trans_img)
                np.save("./original_image_train_cnn_rot.npy", rotated_inputs)
        ...
        if epoch % 5 == 0:
            ...
            for batch in iterate_minibatches(X_test, y_test, 500, shuffle=True):
                ...
                test_batches += 1
                if test_batches == 1:
                    np.save("./unrotated_image_cnn_rot.npy", trans_img)
                    np.save("./original_image_cnn_rot.npy", rotated_inputs)
            print("Final results:")
