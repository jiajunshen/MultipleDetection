...
def build_cnn(input_var=None):
    ...
    # conv1
    conv1 = Conv2DLayer(input_layer, num_filters=64, filter_size=(3,3),
    ...
    conv2a = Conv2DLayer(conv2, 
                        ...
                        name='conv2a')
    # norm2
    norm2 = LocalResponseNormalization2DLayer(conv2a, alpha=0.001 / 9.0,
                                              beta=0.75, k=1.0, n=9)
    ...
    pool3 = MaxPool2DLayer(norm2, pool_size=(2, 2), stride=(2, 2), pad=0)
