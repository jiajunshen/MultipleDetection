...
def build_mask_nn(input_var=None):
    input_layer = InputLayer((None, 35, IMAGE_SIZE, IMAGE_SIZE), input_var=input_var)
    fc1 = DenseLayer(input_layer, num_units = 3000, nonlinearity=lasagne.nonlinearities.rectify,
                     W=lasagne.init.GlorotUniform(), b=lasagne.init.Constant(0.1),
                     name="fc1")
    fc2 = DenseLayer(fc1, num_units=IMAGE_SIZE*IMAGE_SIZE, nonlinearity=lasagne.nonlinearities.sigmoid,
                     W=lasagne.init.GlorotUniform(), b=lasagne.init.Constant(0.1),
                     name="fc2")
    return fc2
