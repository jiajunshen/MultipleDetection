...
def generate(images, labels, background_images, mega_patch_w, result_sample_w, num_strokes, num_samples):
    ...
    for j in range(num_samples):
        ...
        while(intensity < 20):
            ...
            generated_image[j] = background_images[labels[index]]
    ...
    return np.array(generated_image, dtype = np.float32)
