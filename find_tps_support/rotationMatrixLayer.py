...
class RotationTransformationLayer(lasagne.layers.Layer):
    ...
    def __init__(self, incoming, n, name=None, Scaling = lasagne.init.Normal(1), **kwargs):
        super(RotationTransformationLayer, self).__init__(incoming, **kwargs)
        self.n = n
        self.get_output_kwargs = []
        #self.translation = self.add_param(Translation, (n, 2), name = "translation")
        self.scaling = self.add_param(Scaling, (n, 1), name = "scaling")
    ...
    def get_output_for(self, input, **kwargs):
        ...
        #theta = T.stack([ones, zeros, self.translation[:,0], zeros, ones, self.translation[:,1]], axis = 1)
        theta = T.stack([ones, zeros, zeros, zeros, ones, zeros], axis = 1)
