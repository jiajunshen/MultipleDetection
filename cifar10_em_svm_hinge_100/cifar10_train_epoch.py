...
def train():
    ...
    hinge_loss = lasagne.objectives.multiclass_hinge_loss(model_output, target_var)
    ...
    train_fn = theano.function([image_input_var, target_var], [loss, hinge_loss, weight_decay_penalty], updates=updates)
